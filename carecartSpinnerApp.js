            ...
            scriptInjection(CDN_WHEELIFY_URL + "spinner.min.js", function () {
                ...
                function applySASPlugin() {
                    ...
                    carecartSpinnerJquery(".copy-button").click(function () {
                        ...
                        navigator.clipboard.writeText(u.val()), carecartSpinnerJquery(this).html('<i class="fa fa-clone" aria-hidden="true"></i> ' + copiedTextVal);
                        ...
                        if (window.localStorage.getItem('urgencyTimerBarEnabled') == 1 && window.localStorage.getItem('cc-sas-spinner-hide-timer-bar') != 1 && window.localStorage.getItem('cc-sas-spinner-copy-button-clicked') != 1) {
							...
							spinASaleCcUrgencyTimeBarText = spinASaleCcUrgencyTimeBarText.replace(/--coupon_code--/g, wonCouponCode);
                            ...
                            timerDiv = '<span class="cc-spin-a-sale-clock-div" id="cc-spin-a-sale-clock-div-preview"><span style="font-weight: bold;"><span class="cc-spin-a-sale-minutes"></span>:<span class="cc-spin-a-sale-seconds"></span></span></span>';

							spinASaleCcUrgencyTimeBarText = spinASaleCcUrgencyTimeBarText.replace(/--time--/g, timerDiv);
                ...
                function stopShakeButton(response) {
                    if (carecartSpinnerJquery('#wheelify-spin-trigger-cc').hasClass('triggerButton_shake') || carecartSpinnerJquery('#wheelify-spin-trigger-cc').hasClass('vtriggerButton_shake')) {
                        ...
                        var startShakeTimeout = setTimeout(function (response) {
                ...
                function startShakeButton(response) {
                    ...
                    var stopShakeTimeout = setTimeout(function (response) {
                    ...
                    if (response && response._metadata && response._metadata.outcome && response._metadata.outcome == "SUCCESS") {
                        ...
                        if (response.records && response.records.store_settings && response.records.store_settings) {
                            ...
                            if (response.records.store_front_template) {
                                        ...
                                        response.records.store_settings.settings_data.phone_number_country != '') {
                                            ...
                                            if (windowWidth < 575) { 
                                                carecartSpinnerJquery("head").append(
                                                    '<style type="text/css"> .iti.iti--container {z-index: 99999999999 !important} </style>'
                                                ); 
                                            }
                                ...
                                carecartSpinnerJquery("head").append(
                                    '<style type="text/css"> * { box-sizing: border-box !important; } .customInput{ font-size: 16px !important; } #wheelify-couponwheel_notice_content{font-size:1.5em;} </style>'
                                );  
                                
                                if(response.records.store_settings.settings_data.spinner_view_type == 'fullscreen'){
                                    carecartSpinnerJquery("head").append(
                                        '<style type="text/css"> @media only screen a nd (max-width: 575px){ #wheelify-spin_a_sale_cc_store_front_module .wheelify-ContentRight { min-height: 560px !important; } } </style>'
                                    ); 
                                }
                                if(response.records.store_settings.settings_data.spinner_view_type == 'popupview'){
                                    carecartSpinnerJquery("head").append(
                                        '<style type="text/css">  @media only screen and (max-width: 576px){ #wheelify-spin_a_sale_cc_store_front_module.wheelify-wrapper-spinner.popupview .wheelify-ContentRight { min-height: 444px; }} </style>'
                                    ); 
                                }
                                ...
                                /* Append triggered button */
                                    if (response.records.store_settings.settings_data.is_triggered_enable && parseInt(response.records.store_settings.settings_data.is_triggered_enable) == 1) {
                                        ...
                                        if(tBtn.length == 0){
                                            ...
                                            tBtn = carecartSpinnerJquery('body').find('#wheelify-spin-trigger-cc');
                                        }
                                        ...
                                        if(settingsData.button_position === 'middle_right' ) {
                                            ...
                                            if (windowWidth < 575) {
                                                triggerBottom = settingsData.trigger_btn_margin_mobile / 4;
                                                triggerBottom === 0 ? triggerBottom =  15 : triggerBottom += 15;
                                            }
                                            else{
                                                triggerBottom = settingsData.trigger_btn_margin_desktop / 3
                                            ...
                                            verticalShake = setInterval(function(){
                ...
                */
                ...
                function checkCollectionsCcSpinASale() {
                    ...
                    var is_page = !(!window.location.pathname.match("(.*)/shop(.*)") && !window.location.pathname.match("(.*)/shop") || window.location.pathname.match("(.*)/store(.*)") || window.location.pathname.match("(.*)/store") || window.location.pathname.match("(.*)/collections/(.*)") || window.location.pathname.match("(.*)/collections"));
                    return is_page;
                }

                function checkBlogPageCcSpinASale() {
                    //console.log('SAS inside checkBlogPageCcSpinASale');
                    var is_page = !(!window.location.pathname.match("(.*)/blog(.*)") && !window.location.pathname.match("(.*)/blog"));
                    return is_page;
                }

                function checkProductCcSpinASale() {
                    //console.log('SAS inside checkProductCcSpinASale');
                    var is_page = !(!window.location.pathname.match("(.*)/product-page/(.*)"));
                    return is_page;
                }
                ...
                function checkThanksYouCcSpinASale() {
                    ...
                    var is_page = !(!window.location.pathname.match("(.*)/thank-you-page/(.*)") && !window.location.pathname.match("(.*)/thank-you-page"));
                    //console.log(is_page);
                    return is_page;
                }
                ...
                if (!getParameterByName('cc-show-spin-a-sale-test')) {
                    ...
                    */
                    ...
                    function onUrlChange() {
                        ...
                        carecartSpinnerJquery("#wheelify-spin_a_sale_cc_store_front_module").remove();
                        carecartSpinnerJquery("#wheelify-spin-trigger-cc").css("buttom", "0px");
                        carecartSpinnerJquery("#wheelify-spin-trigger-cc").remove();
                        ...
                        if(url == "/") {
                            ccCurPage = 'home';
                            otherPage = true;
                        } else if (!(!url.match("(.*)/shop(.*)") && !url.match("(.*)/shop") || url.match("(.*)/store(.*)") || url.match("(.*)/store") || url.match("(.*)/collections/(.*)") || url.match("(.*)/collections"))) {
                            ccCurPage = 'collections';
                            otherPage = true;
                        } else if (!(!url.match("(.*)/blog(.*)") && !url.match("(.*)/blog"))) {
                            ccCurPage = 'blogs';
                            otherPage = true;
                        } else if (!(!url.match("(.*)/product-page/(.*)"))) {
                            ccCurPage = 'products';
                            otherPage = true;
                        } else if (!(!url.match("(.*)/cart/(.*)") && !url.match("(.*)/cart"))) {
                            ccCurPage = 'cart';
                            otherPage = true;
                        } else if ( !(!url.match("(.*)/thank-you-page/(.*)") && !url.match("(.*)/thank-you-page") || url.match("(.*)/checkout(.*)" || url.match("(.*)/checkout")))) {
                            ccCurPage = 'thankYou';
                            otherPage = true;
                        } else if (otherPage) {
                            ccCurPage = 'otherPage';
